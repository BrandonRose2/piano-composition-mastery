      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[#8a7a5a] text-sm leading-relaxed">
                Every Sunday at 9:00 AM UTC, a Manus agent scans your Downloads folder for new PDF sheet music files.
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center px-6">
              ...
              <p className="text-[#6a5a3a] text-sm mt-1">
                The weekly agent will run every Sunday and automatically import new PDFs from your Downloads folder.
              </p>
            </div>
          ) : (
        ...
        <div className="bg-[#111] border border-[#2a2a2a] rounded-xl p-6">
          ...
          <ol className="space-y-3">
            {[
              "Every Sunday at 9 AM UTC, a Manus agent wakes up and scans your Mac's Downloads folder",
              ...
              "You'll see all new compositions in your library the next time you visit",
            ].map((step, i) => (
